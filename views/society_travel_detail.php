...
<div>
  ...
  <section class="cd-faq">
    <ul class="cd-faq-categories">
      <li><a class="selected" href="#basics">5iweb</a></li>
      <li><a href="#mobile">HTML5</a></li>
      <li><a href="#account">jQuery</a></li>
      <li><a href="#payments">CSS3</a></li>
      <li><a href="#privacy">SVG</a></li>
      <li><a href="#delivery">CANVAS</a></li>
    </ul> <!-- cd-faq-categories -->

    <div class="cd-faq-items">
      <ul id="basics" class="cd-faq-group">
        <li class="cd-faq-title"><h2>5iweb</h2></li>
        <li>
