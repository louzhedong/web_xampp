      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="strategy-search">
            ...
            <input type="text" class="strategy-search-input" placeholder="请输入想去的地方，如:香港">
          </div>
        </div>
        <div class="col-md-8">
          <div class="carousel">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="total-strategy">
          <div class="total-strategy-header">
            所有攻略
          </div>
